...
export const widgetTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    childClassFilter: z.string().optional().describe("inspect_runtime_instances: class substring filter for subtree nodes"),
    world: z.enum(["editor", "pie", "game", "auto"]).optional().describe("Runtime world scope"),
