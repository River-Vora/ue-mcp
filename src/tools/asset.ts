...
export const assetTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    continueOnError: z.boolean().optional().describe("set_mesh_materials_batch: apply the entries that passed preflight instead of aborting the whole batch (default false). Rejected entries are still reported in items[]"),
