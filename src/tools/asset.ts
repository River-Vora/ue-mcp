...
export const assetTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    ])).optional().describe("Batch entries: import_texture_batch takes {filePath, packagePath?, name?, replaceExisting?}; bulk_upsert_data_assets takes {name, packagePath, className, properties?}"),
    save: z.boolean().optional().describe("import_texture_batch / bulk_upsert_data_assets: save changed packages immediately (default true)"),
