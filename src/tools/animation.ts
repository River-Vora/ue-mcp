...
export const animationTool: ToolDef = categoryTool(
  ...
  "Animation assets, skeletons, montages, blendspaces, anim blueprints, physics assets.",
  {
    ...
    author_montages_batch: bp("Batch-author animation montages with slot/blend configuration, sections, custom notify classes/properties, per-item results, idempotency, saving, and rollback metadata. Params: items[]", "author_montages_batch", (p) => ({ items: p.items })),
